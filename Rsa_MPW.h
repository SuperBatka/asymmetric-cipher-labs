#ifndef RSA_MENUPAGE_WIDGET_H
#define RSA_MENUPAGE_WIDGET_H
...
class Rsa_MPW : public QWidget
{
    Q_OBJECT
public:
    explicit Rsa_MPW(QWidget *parent = nullptr);
